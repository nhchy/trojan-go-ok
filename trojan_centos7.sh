...
yum -y install bind-utils wget unzip zip curl tar socat
green "======================="
yellow "请输入绑定到本VPS的域名"
green "======================="
read your_domain
green "======================="
yellow "请输入注册acme的email"
green "======================="
read your_email
...
if [ $real_addr == $local_addr ] ; then
	...
	wget https://raw.githubusercontent.com/nhchy/trojan-go-ok/main/web.zip
    	unzip web.zip
	...
	wget https://github.com/p4gefau1t/trojan-go/releases/download/v0.10.6/trojan-go-windows-386.zip
	mkdir trojan-cli
	cd trojan-cli
	unzip ../trojan-go-windows-386.zip
	cd ..
...
ExecStart=/usr/src/trojan/trojan-go -c "/usr/src/trojan/server.conf"  
ExecReload=  
ExecStop=/usr/src/trojan/trojan-go  
PrivateTmp=true  
